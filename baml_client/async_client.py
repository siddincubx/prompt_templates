...
class BamlAsyncClient:
    ...
    async def CreateTemplate(self, requirement: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="CreateTemplate", args={
...
class BamlStreamClient:
    ...
    def CreateTemplate(self, requirement: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Template, types.Template]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="CreateTemplate", args={
            "requirement": requirement,
        })
        return baml_py.BamlStream[stream_types.Template, types.Template](
          result,
